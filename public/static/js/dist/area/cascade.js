...
function cascdeInit(na,os,v1,v2,v3,v4,v5) {
    ...
    id3= "sel-area";
    id4= "sel-street";
    id5= "chose_province_code";
    id6= "chose_city_code";
    id7= "chose_area_code";
    id8= "chose_street_code";
    ...
    var dropElement5 = document.getElementById(id5);
    var dropElement6 = document.getElementById(id6);
    var dropElement7 = document.getElementById(id7);
    var dropElement8 = document.getElementById(id8);
    ...
    if (TopnodeList.length > 0) {
        ...
        for (var i = 0; i < TopnodeList.length; i++) {
            ...
            option.value = county.getAttribute("code");
        ...
        if (TopnodeList.length > 0) {
            ...
            for (var i = 0; i < citys.length; i++) {
                ...
                var option = document.createElement("option");
                option.value = province[i] .getAttribute("code");
...
function selectCity(v5) {
    ...
    var dropElement1 = document.getElementById(id1);
    var province = $("#sel-provance option:selected").text();
    var province_code = $("#sel-provance option:selected").val();
    $("input[name=province]").val(province);
    $("input[name=chose_province_code]").val(province_code);
    ...
    if (citynodes.length > 0) {
        ...
        for (var i = 0; i < citynodes.length; i++) {
            ...
            var option = document.createElement("option");
            option.value = provinceNode.getAttribute("code");
        ...
        if (countycodes.length > 0) {
            ...
            for (var i = 0; i < countycodes.length; i++) {
                ...
                var option = document.createElement("option");
                option.value = countycodes[i].getAttribute("code");
...
function selectcounty(v3,v4,v5) {
    ...
    var dropElement1 = document.getElementById(id1);
    var dropElement2 = document.getElementById(id2);
    var city = $("#sel-city option:selected").text();
    var city_code = $("#sel-city option:selected").val();
    $("input[name=city]").val(city);
    $("input[name=chose_city_code]").val(city_code);
    ...
    if (countys.length > 0) {
        for (var i = 0; i < countys.length; i++) {
            ...
            var option = document.createElement("option");
            option.value = countyNode.getAttribute("code");
...
function selectstreet(v4,v5) {
    ...
    var dropElement1 = document.getElementById(id1);
    var dropElement2 = document.getElementById(id2);
    var area = $("#sel-area option:selected").text();
    var area_code = $("#sel-area option:selected").val();
    $("input[name=area]").val(area);
    $("input[name=chose_area_code]").val(area_code);
    var name = dropElement2.options[dropElement2.selectedIndex].value;
    var dropElement3 = document.getElementById(id3);
    var dropElement4 = document.getElementById(id4);
        ...
        for (var i = 0; i < CityList.length; i++) {
            ...
            if(county_code == area_code){
                ...
                for (var m = 0; m < streetlist.length; m++) {
                    ...
                    var option = document.createElement("option");
                    option.value = street.getAttribute("code");
