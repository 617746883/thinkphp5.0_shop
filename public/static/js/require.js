...
try {
    if (window.console && window.console.log) {
        console.log("%c欢迎使用商城平台管理系统 ^_^ ：", "height:25px; line-height:25px;");
        console.log("%c1，一款免费开源的平台管理系统\n2，基于目前最流行的WEB2.0的架构（php+mysql）\n3，源码透明、开放，保证独立性、安全性及可控性\n4，良好的开发框架、文档，轻松扩展、定制私有功能\n", "color:green;line-height:25px;");
        console.log("%cAuthor：SUL1SS", "color:blue")
        console.log("%c作者邮箱：617746883@qq.com", "color:red")
    }
} catch (e) {};