define(['core', 'tpl'], function(core, tpl) {
    ...
    modal.initList = function() {
        ...
        $('*[data-toggle=delete]').unbind('click').click(function() {
            ...
            FoxUI.confirm('删除后无法恢复, 确认要删除吗 ?', function() {
                core.json('mobile/member/addressdelete', {
                    id: id
                }, function(ret) {
                    if (ret.status == 1) {
        ...
        $(document).on('click', '[data-toggle=setdefault]', function() {
            ...
            core.json('mobile/member/addresssetdefault', {
                id: id
            }, function(ret) {
                if (ret.status == 1) {
    ...
    modal.initPost = function(params) {
        ...
        $(document).on('click', '#btn-submit', function() {
            ...
            core.json('mobile/member/addresssubmit', {
                id: $('#addressid').val(),
    ...
    modal.loadSelectorData = function() {
        core.json('mobile/member/addressget_list', {}, function() {})
    };
