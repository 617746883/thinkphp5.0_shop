...
class Order extends Base
{
	...
	public function listdata($status = '')
	{
		...
		$this->assign(['list'=>$list,'pager'=>$pager,'searchfield'=>$searchfield,'r_type'=>$r_type,'starttime'=>$starttime,'endtime'=>$endtime,'is_openmerch'=>$is_openmerch,'keyword'=>$keyword,'searchtime'=>$searchtime,'paytype'=>$paytype,'total'=>$total,'totalmoney'=>$totalmoney]);
