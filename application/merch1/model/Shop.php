...
class Shop extends \think\Model
{
	...
	public static function getCategory()
	{
		$parents = array();
		$children = array();
		$category = Db::name('shop_store_goods_category')->where('enabled',1)->order('parentid','asc')->order('displayorder','desc')->select();
	...
	{
		$allcategory = Db::name('shop_store_goods_category')->field('id,parentid,name,thumb')->select();
		return $allcategory;
	}
