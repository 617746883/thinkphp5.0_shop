...
class Order extends Base
{
	...
	public function listdata($status = '')
	{
		...
		$condition = ' o.merchshow = 1 and o.ismr=0 and o.deleted=0 and o.istrade=0 ';
	...
	{
		$merch = intval(input('merch'));
		$totals = model('order')->getTotals($merch);
	...
	public function refund()
	{
		...
		$item = Db::name('shop_order')->where('id',$orderid)->find();
